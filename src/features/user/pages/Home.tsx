          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="p-8 rounded-2xl bg-blue-50/50 border border-blue-100 hover:shadow-xl transition-shadow duration-300">
                <div className="w-14 h-14 bg-blue-100 text-blue-600 rounded-xl flex items-center justify-center mb-6"><Zap className="w-7 h-7" /></div>
              ...
              <div className="p-8 rounded-2xl bg-indigo-50/50 border border-indigo-100 hover:shadow-xl transition-shadow duration-300">
                <div className="w-14 h-14 bg-indigo-100 text-indigo-600 rounded-xl flex items-center justify-center mb-6"><ShieldCheck className="w-7 h-7" /></div>
              ...
              <div className="p-8 rounded-2xl bg-sky-50/50 border border-sky-100 hover:shadow-xl transition-shadow duration-300">
                <div className="w-14 h-14 bg-sky-100 text-sky-600 rounded-xl flex items-center justify-center mb-6"><Clock className="w-7 h-7" /></div>
