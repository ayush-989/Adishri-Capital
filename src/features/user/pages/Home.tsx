    ...
    <MainLayout>
      <div className="bg-white overflow-hidden">
        ...
        <section className="relative bg-gradient-to-br from-slate-950 via-blue-950 to-indigo-950 text-white overflow-hidden">
          ...
          <div className="relative max-w-5xl mx-auto px-4 pt-14 pb-18 sm:pt-24 sm:pb-28 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 bg-blue-500 hover:bg-blue-400 active:bg-blue-600 text-white font-bold px-7 py-4 rounded-2xl text-base transition-all duration-200 shadow-lg shadow-blue-500/30 hover:-translate-y-0.5"
              >
        ...
        <section className="py-14 sm:py-20 bg-slate-50">
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                { icon: Zap, title: "Lightning Fast", desc: "Approval in minutes, disbursal almost instantly.", bg: "bg-blue-50", iconColor: "text-blue-600" },
                { icon: ShieldCheck, title: "100% Secure", desc: "Bank-grade encryption protects your data always.", bg: "bg-indigo-50", iconColor: "text-indigo-600" },
                { icon: Clock, title: "Flexible Repay", desc: "Choose a repayment schedule that suits your life.", bg: "bg-violet-50", iconColor: "text-violet-600" },
              ].map((f) => (
        ...
        <section className="py-14 sm:py-20 bg-white">
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-10">
              ...
              <p className="text-slate-500 text-sm mt-2 max-w-md mx-auto">Tailored loan products for every financial situation.</p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {LOAN_TYPES.map((loan) => {
                const Icon = loan.icon;
                return (
                  <div key={loan.title} className={`rounded-2xl border ${loan.light} p-6 flex flex-col gap-4 hover:shadow-lg transition-all duration-300 hover:-translate-y-1`}>
                    ...
                    <div className="flex-1">
                      ...
                      <span className="inline-block bg-white border text-xs font-bold px-2.5 py-1 rounded-full mb-3 text-slate-700">{loan.rate}</span>
                      <p className="text-slate-500 text-sm leading-relaxed">{loan.desc}</p>
                    </div>
                    <Link to={ROUTES.LOAN_APPLICATION} className={`inline-flex items-center gap-1 text-sm font-semibold ${loan.accent} hover:gap-2 transition-all`}>
        ...
        <section className="py-14 sm:py-20 bg-slate-50">
          <div className="max-w-4xl mx-auto px-4">
            <div className="text-center mb-8">
              ...
              <p className="text-slate-500 text-sm mt-2">No surprises. Know exactly what you're paying.</p>
            </div>
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
              {/* Mobile cards */}
              <div className="sm:hidden divide-y divide-slate-100">
                {[
                  { type: "Personal Loan", range: "₹5K–₹2L", rate: "3%–12% flat", tenure: "1–24 mo" },
                  { type: "Short-Term", range: "₹1K–₹50K", rate: "5%–15% flat", tenure: "7–90 days" },
                  { type: "Business Micro", range: "₹10K–₹5L", rate: "2.5%–10% flat", tenure: "3–36 mo" },
                ].map((row) => (
                  <div key={row.type} className="p-5">
                    <p className="font-bold text-slate-900 mb-3">{row.type}</p>
                    <div className="grid grid-cols-2 gap-2 text-sm">
                      <div><p className="text-slate-400 text-xs mb-0.5">Amount Range</p><p className="font-medium text-slate-700">{row.range}</p></div>
                      <div><p className="text-slate-400 text-xs mb-0.5">Interest Rate</p><p className="font-medium text-slate-700">{row.rate}</p></div>
                      <div><p className="text-slate-400 text-xs mb-0.5">Tenure</p><p className="font-medium text-slate-700">{row.tenure}</p></div>
                      <div><p className="text-slate-400 text-xs mb-0.5">Processing Fee</p><p className="font-semibold text-blue-600">₹49 (one-time)</p></div>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <p className="text-xs text-slate-400 text-center mt-3">* Final rate set by admin at time of approval.</p>
          </div>
        </section>

        {/* ── ELIGIBILITY + HOW IT WORKS ── */}
        <section className="py-14 sm:py-20 bg-gradient-to-br from-slate-900 to-blue-950 text-white">
          <div className="max-w-6xl mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
              <div>
                ...
                <p className="text-slate-400 text-sm mb-7 leading-relaxed">Minimal requirements so more people can access credit quickly.</p>
                ...
                <Link to={ROUTES.LOAN_APPLICATION} className="inline-flex items-center gap-2 mt-8 bg-blue-500 hover:bg-blue-400 text-white font-bold px-6 py-3.5 rounded-2xl text-sm transition-all">
              ...
              <div>
                ...
                <h2 className="text-2xl sm:text-3xl font-bold mb-7">How It Works</h2>
        ...
        {/* ── BOTTOM CTA ── */}
        <section className="bg-gradient-to-br from-blue-600 to-indigo-700 py-14 sm:py-20">
          <div className="max-w-3xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link
                to={ROUTES.LOAN_APPLICATION}
                className="inline-flex items-center justify-center gap-2 bg-white text-blue-700 font-bold px-7 py-4 rounded-2xl text-base hover:bg-blue-50 transition-all shadow-lg"
              >
