        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <p className="text-slate-600 mt-2">
              Please pay the processing fee of <strong className="text-slate-900">₹{PROCESSING_FEE_AMOUNT}</strong> to continue with application <span className="font-mono bg-slate-100 px-2 py-1 rounded">{loanId}</span>.
            </p>
          </CardHeader>
